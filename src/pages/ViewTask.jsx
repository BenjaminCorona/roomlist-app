          ...
          <div className="flex flex-col md:flex-row h-[600px]">
            ...
            <div className="w-full md:w-64 border-t md:border-t-0 md:border-l border-gray-200 p-6 space-y-6 bg-gray-50">
              ...
              <div className="space-y-2">
                ...
                {[
                  { label: 'Fecha de inicio', value: fechaInicio ? new Date(fechaInicio).toLocaleDateString() : 'Sin asignar' },
                  { label: 'Fecha de fin', value: fechaFin ? new Date(fechaFin).toLocaleDateString() : 'Sin asignar' }
                ].map((item, index) => (
